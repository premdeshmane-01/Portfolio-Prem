        ...
        <div className="flex-1 flex flex-col justify-end pb-20 sm:pb-0 sm:justify-center items-start px-6 md:pl-24 md:pr-8 space-y-6 md:space-y-10 max-w-4xl pt-12 md:pt-0">
          ...
          >
            <div className="inline-flex items-center gap-2 md:gap-3 px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-xl hover:bg-white/10 transition-colors cursor-default">
              ...
              <span className="text-[10px] md:text-[11px] font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] text-white/80">
          ...
          <div className="space-y-0 relative w-full">
            ...
            <div className="overflow-hidden relative pb-1 md:pb-0">
              <motion.h1
                ...
                className="text-5xl sm:text-7xl md:text-9xl font-black text-white/40 tracking-tighter leading-[0.9]"
              >
                DESHMANE
              </motion.h1>
              <motion.div
                className="absolute top-1/2 -translate-y-1/2 -left-3 md:-left-8 w-1 md:w-2 h-[60%] md:h-[80%] bg-white"
          ...
          <motion.div
            ...
            className="space-y-3 pl-1 md:pl-2"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-4 sm:gap-5 pt-4 md:pt-8 pl-1 md:pl-2 w-full sm:w-auto"
          >
            <motion.a
              href="#projects"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="group relative px-8 py-3.5 md:py-4 bg-white text-black font-bold text-sm tracking-[0.2em] uppercase overflow-hidden text-center sm:text-left"
            >
              ...
              <span className="relative z-10 flex items-center justify-center sm:justify-start gap-3 group-hover:text-white transition-colors duration-300">
                Explore Work
              </span>
            </motion.a>
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="group px-8 py-3.5 md:py-4 border border-white/20 text-white font-bold text-sm tracking-[0.2em] uppercase transition-all hover:bg-white/5 backdrop-blur-sm text-center sm:text-left"
            >
          ...
          <motion.div
            ...
            className="absolute bottom-6 md:bottom-12 left-1/2 -translate-x-1/2 flex items-center gap-4"
          >
